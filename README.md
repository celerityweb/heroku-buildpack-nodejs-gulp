...
- Run `heroku config:set NODE_ENV=development` to set your environment to `development` (or any other name)
- Add a Gulp task called `heroku:development` that builds your app
